require(['$'], function() {
	$(function() {
	    ...
	    if(pvarIsLogin == "true"){
	    	var dataURL ="/kr/ko/life/event/evt20180701/checkTime";
	    	...
	    	$.ajax({
					...
					success : function(data) {
						...
						$('.calc_area .calTd').each(function(index,value) {
				            ...
				            if (data.list.indexOf('2018' +'07'+ day+'') >= 0) {
				            	me.addClass("ok");
				            	cnt +=1;
				            }
				        });
			...
			var data = "today="+chan_val+"&seq="+evtId+"&method=evtApply";
				...
				$.ajax({
					...
					success : function(response) {
						...
						//appBoy 통계
						appboy.logCustomEvent("event_20180701_ok");
...
function callAjax(data,couponMsg){
	$.ajax({
		type : "POST",
		url : "/kr/ko/life/event/evt20180701/coupon",
		cache : false,
		data : "couponSeq="+data,
		dataType : "json",
		success : function(response) {
